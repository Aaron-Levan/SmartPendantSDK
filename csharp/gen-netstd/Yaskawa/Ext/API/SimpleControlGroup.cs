...
namespace Yaskawa.Ext.API
{
  ...
  public partial class SimpleControlGroup : TBase
  {
    ...
    {
      var tmp169 = new SimpleControlGroup();
      if(__isset.type)
      {
        tmp169.Type = this.Type;
      }
      tmp169.__isset.type = this.__isset.type;
      if(__isset.index)
      {
        tmp169.Index = this.Index;
      }
      tmp169.__isset.index = this.__isset.index;
      return tmp169;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp170 = new TStruct("SimpleControlGroup");
    ...
    {
      var tmp172 = new StringBuilder("SimpleControlGroup(");
      int tmp173 = 0;
      if(__isset.type)
      {
        if(0 < tmp173++) { tmp172.Append(", "); }
        tmp172.Append("Type: ");
        Type.ToString(tmp172);
      }
      if(__isset.index)
      {
        if(0 < tmp173++) { tmp172.Append(", "); }
        tmp172.Append("Index: ");
        Index.ToString(tmp172);
      }
      tmp172.Append(')');
