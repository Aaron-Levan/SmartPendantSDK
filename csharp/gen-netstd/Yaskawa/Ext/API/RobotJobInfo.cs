...
namespace Yaskawa.Ext.API
{
  ...
  public partial class RobotJobInfo : TBase
  {
    ...
    {
      var tmp188 = new RobotJobInfo();
      if((Name != null) && __isset.name)
      {
        tmp188.Name = this.Name;
      }
      tmp188.__isset.name = this.__isset.name;
      if((ProgrammingLanguage != null) && __isset.programmingLanguage)
      {
        tmp188.ProgrammingLanguage = this.ProgrammingLanguage;
      }
      tmp188.__isset.programmingLanguage = this.__isset.programmingLanguage;
      if((JobType != null) && __isset.jobType)
      {
        tmp188.JobType = this.JobType;
      }
      tmp188.__isset.jobType = this.__isset.jobType;
      if(__isset.editable)
      {
        tmp188.Editable = this.Editable;
      }
      tmp188.__isset.editable = this.__isset.editable;
      if(__isset.timestamp)
      {
        tmp188.Timestamp = this.Timestamp;
      }
      tmp188.__isset.timestamp = this.__isset.timestamp;
      if((Datetime != null) && __isset.datetime)
      {
        tmp188.Datetime = this.Datetime;
      }
      tmp188.__isset.datetime = this.__isset.datetime;
      if((Comment != null) && __isset.comment)
      {
        tmp188.Comment = this.Comment;
      }
      tmp188.__isset.comment = this.__isset.comment;
      if((Frame != null) && __isset.frame)
      {
        tmp188.Frame = (global::Yaskawa.Ext.API.CoordinateFrame)this.Frame.DeepCopy();
      }
      tmp188.__isset.frame = this.__isset.frame;
      if((Controlling != null) && __isset.controlling)
      {
        tmp188.Controlling = (global::Yaskawa.Ext.API.ControlGroup)this.Controlling.DeepCopy();
      }
      tmp188.__isset.controlling = this.__isset.controlling;
      return tmp188;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp189 = new TStruct("RobotJobInfo");
        ...
        if((ProgrammingLanguage != null) && __isset.programmingLanguage)
        {
          tmp190.Name = "programmingLanguage";
          tmp190.Type = TType.String;
          tmp190.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp190, cancellationToken);
        ...
        if(__isset.editable)
        {
          tmp190.Name = "editable";
          tmp190.Type = TType.Bool;
          tmp190.ID = 4;
          await oprot.WriteFieldBeginAsync(tmp190, cancellationToken);
    ...
    {
      var tmp191 = new StringBuilder("RobotJobInfo(");
      int tmp192 = 0;
      if((Name != null) && __isset.name)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("Name: ");
        Name.ToString(tmp191);
      }
      if((ProgrammingLanguage != null) && __isset.programmingLanguage)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("ProgrammingLanguage: ");
        ProgrammingLanguage.ToString(tmp191);
      }
      if((JobType != null) && __isset.jobType)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("JobType: ");
        JobType.ToString(tmp191);
      }
      if(__isset.editable)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("Editable: ");
        Editable.ToString(tmp191);
      }
      if(__isset.timestamp)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("Timestamp: ");
        Timestamp.ToString(tmp191);
      }
      if((Datetime != null) && __isset.datetime)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("Datetime: ");
        Datetime.ToString(tmp191);
      }
      if((Comment != null) && __isset.comment)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("Comment: ");
        Comment.ToString(tmp191);
      }
      if((Frame != null) && __isset.frame)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("Frame: ");
        Frame.ToString(tmp191);
      }
      if((Controlling != null) && __isset.controlling)
      {
        if(0 < tmp192++) { tmp191.Append(", "); }
        tmp191.Append("Controlling: ");
        Controlling.ToString(tmp191);
      }
      tmp191.Append(')');
