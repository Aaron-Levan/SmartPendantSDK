...
namespace Yaskawa.Ext.API
{
  ...
  public partial class PropValues : TBase
  {
    ...
    {
      var tmp149 = new PropValues();
      if((ItemID != null))
      {
        tmp149.ItemID = this.ItemID;
      }
      if((Props != null))
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                {
                  var _map150 = await iprot.ReadMapBeginAsync(cancellationToken);
                  Props = new Dictionary<string, global::Yaskawa.Ext.API.Any>(_map150.Count);
                  for(int _i151 = 0; _i151 < _map150.Count; ++_i151)
                  {
                    string _key152;
                    global::Yaskawa.Ext.API.Any _val153;
                    _key152 = await iprot.ReadStringAsync(cancellationToken);
                    _val153 = new global::Yaskawa.Ext.API.Any();
                    await _val153.ReadAsync(iprot, cancellationToken);
                    Props[_key152] = _val153;
                  }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp154 = new TStruct("PropValues");
    ...
    {
      var tmp157 = new StringBuilder("PropValues(");
      if((ItemID != null))
      {
        tmp157.Append(", ItemID: ");
        ItemID.ToString(tmp157);
      }
      if((Props != null))
      {
        tmp157.Append(", Props: ");
        Props.ToString(tmp157);
      }
      tmp157.Append(')');
