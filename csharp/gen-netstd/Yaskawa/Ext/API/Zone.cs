...
namespace Yaskawa.Ext.API
{
  ...
  public partial class Zone : TBase
  {
    ...
    public Zone DeepCopy()
    {
      ...
      if(__isset.number)
      {
        tmp215.Number = this.Number;
      }
      tmp215.__isset.number = this.__isset.number;
      if((Name != null) && __isset.name)
      {
        tmp215.Name = this.Name;
      }
      tmp215.__isset.name = this.__isset.name;
      if(__isset.enabled)
      {
        tmp215.Enabled = this.Enabled;
      }
      tmp215.__isset.enabled = this.__isset.enabled;
      if(__isset.action)
      {
        tmp215.Action = this.Action;
      }
      tmp215.__isset.action = this.__isset.action;
      if((MinPos != null) && __isset.minPos)
      {
        tmp215.MinPos = (global::Yaskawa.Ext.API.Position)this.MinPos.DeepCopy();
      }
      tmp215.__isset.minPos = this.__isset.minPos;
      if((MaxPos != null) && __isset.maxPos)
      {
        tmp215.MaxPos = (global::Yaskawa.Ext.API.Position)this.MaxPos.DeepCopy();
      }
      tmp215.__isset.maxPos = this.__isset.maxPos;
      return tmp215;
    }
    ...
    {
      var tmp218 = new StringBuilder("Zone(");
      int tmp219 = 0;
      if(__isset.number)
      {
        if(0 < tmp219++) { tmp218.Append(", "); }
        tmp218.Append("Number: ");
        Number.ToString(tmp218);
      }
      if((Name != null) && __isset.name)
      {
        if(0 < tmp219++) { tmp218.Append(", "); }
        tmp218.Append("Name: ");
        Name.ToString(tmp218);
      }
      if(__isset.enabled)
      {
        if(0 < tmp219++) { tmp218.Append(", "); }
        tmp218.Append("Enabled: ");
        Enabled.ToString(tmp218);
      }
      if(__isset.action)
      {
        if(0 < tmp219++) { tmp218.Append(", "); }
        tmp218.Append("Action: ");
        Action.ToString(tmp218);
      }
      if((MinPos != null) && __isset.minPos)
      {
        if(0 < tmp219++) { tmp218.Append(", "); }
        tmp218.Append("MinPos: ");
        MinPos.ToString(tmp218);
      }
      if((MaxPos != null) && __isset.maxPos)
      {
        if(0 < tmp219++) { tmp218.Append(", "); }
        tmp218.Append("MaxPos: ");
        MaxPos.ToString(tmp218);
      }
      tmp218.Append(')');
