...
namespace Yaskawa.Ext.API
{
  ...
  public partial class PendantEvent : TBase
  {
    ...
    {
      var tmp139 = new PendantEvent();
      tmp139.EventType = this.EventType;
      if((Props != null) && __isset.props)
      {
        tmp139.Props = this.Props.DeepCopy();
      }
      tmp139.__isset.props = this.__isset.props;
      return tmp139;
    }
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 2:
              ...
              {
                {
                  var _map140 = await iprot.ReadMapBeginAsync(cancellationToken);
                  Props = new Dictionary<string, global::Yaskawa.Ext.API.Any>(_map140.Count);
                  for(int _i141 = 0; _i141 < _map140.Count; ++_i141)
                  {
                    string _key142;
                    global::Yaskawa.Ext.API.Any _val143;
                    _key142 = await iprot.ReadStringAsync(cancellationToken);
                    _val143 = new global::Yaskawa.Ext.API.Any();
                    await _val143.ReadAsync(iprot, cancellationToken);
                    Props[_key142] = _val143;
                  }
    ...
    {
      var tmp147 = new StringBuilder("PendantEvent(");
      tmp147.Append(", EventType: ");
      EventType.ToString(tmp147);
      if((Props != null) && __isset.props)
      {
        tmp147.Append(", Props: ");
